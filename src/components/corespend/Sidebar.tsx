...
type NavItem = { key: ActiveView; label: string; emoji: string };

const PRIMARY: NavItem[] = [
  { key: "dashboard", label: "Core Dashboard", emoji: "📊" },
  { key: "start", label: "Core Start", emoji: "🚀" },
  { key: "kategorie", label: "Core Kategorien", emoji: "🗂️" },
  { key: "upload", label: "Core DataUpload", emoji: "📥" },
];
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        >
          <div className="flex items-center gap-2.5">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-primary to-success grid place-items-center shrink-0 text-[10px] font-bold text-background">
              AI
            </div>
            <div className="min-w-0">
              ...
              <div className="text-[10px] uppercase tracking-wider text-success/90 flex items-center gap-1 mt-0.5">
                <span className="text-[10px]">🔒</span> Coming Soon
              </div>
            </div>
          </div>
